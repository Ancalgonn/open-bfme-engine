...
if ($version -ne "3.12.10") {
    throw "Python 3.12.10 is required; found $version."
}
...
try {
    ...
    if (
        $runtime.version -ne "3.12.10" -or
        $runtime.launcher_sha256 -notin @(
        ...
        $runtime.base_dll_sha256 -ne "9a0e3435aaa680d868150f87ab3e388ad2eebc22f87e036155c7b4eda8cd2120" -or
        $runtime.tree_sha256 -ne "98348e31da2e14c684372bf02fee52b71984d28d8a91b82dbe0fe9aa2f6561d7"
    ) {
        throw "Bundled Python runtime does not match the pinned 3.12.10 identity."
    }
